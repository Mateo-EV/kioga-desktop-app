 ...
 * @author intel
 */
public class DeleteCustomerForm extends javax.swing.JPanel {

    private final List<Customer> customersToDelete;

    public DeleteCustomerForm(List<Customer> brandsToDelete) {
        initComponents();
        ...
        deleteBtn.addActionListener((e) -> {
            ...
            ServiceWorker.execute(() -> {
                ...
                for (Customer customer : customersToDelete) {
                    CustomerController.getInstance().delete(customer.getId(),
