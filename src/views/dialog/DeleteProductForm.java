 ...
 * @author intel
 */
public class DeleteProductForm extends javax.swing.JPanel {

    private final List<Product> productsToDelete;

    public DeleteProductForm(List<Product> productsToDelete) {
        initComponents();
