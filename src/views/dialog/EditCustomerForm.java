 ...
 * @author intel
 */
public class EditCustomerForm extends javax.swing.JPanel {
    ...
    private Customer customerLoaded = new Customer();

    public EditCustomerForm(int id) {
        initComponents();
        customerLoaded.setId(id);
        init();
    }
    ...
    private void init() {
        ...
        CustomerController.getInstance().findById(customerLoaded.getId(),
            new ApiClient.onResponse() {
            @Override
            public void onSuccess(ApiClient.ApiResponse apiResponse) {
                customerLoaded = (Customer) apiResponse.getData();
                txtName.setText(customerLoaded.getName());
                txtEmail.setText(customerLoaded.getEmail());
                stopLoadingState();
            }
        ...
        saveBtn.addActionListener((e) -> {
            ...
            customer.setId(customerLoaded.getId());
            customer.setName(txtName.getText());
            customer.setEmail(txtEmail.getText());
            customer.setPassword(
                String.valueOf(txtPassword.getPassword()).trim());

            CustomerController.getInstance().update(customer,
                new ApiClient.onResponse() {
                @Override
                public void onSuccess(ApiClient.ApiResponse apiResponse) {
                    GlassPanePopup.closePopupLast();
