 ...
 * @author intel
 */
public class DeleteAdminForm extends javax.swing.JPanel {

    private final List<Admin> customersToDelete;

    public DeleteAdminForm(List<Admin> brandsToDelete) {
        initComponents();
        this.customersToDelete = brandsToDelete;
        init();
    }
        ...
        deleteBtn.addActionListener((e) -> {
            ...
            ServiceWorker.execute(() -> {
                CountDownLatch latch = new CountDownLatch(
                    customersToDelete.size());
                for (Admin customer : customersToDelete) {
                    AdminController.getInstance().delete(customer.getId(),
